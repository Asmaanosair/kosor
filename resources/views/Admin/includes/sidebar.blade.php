                                    ...
                                    <div class="carousel-inner" role="listbox">
                                        <div class="carousel-item active">
                                            <div class="container"> <img class="d-block img-fluid"
                                                                         src="{{AdminAssets()}}/images/big/img1.jpg" alt="First slide"></div>
                                        </div>
                                        <div class="carousel-item">
                                            <div class="container"><img class="d-block img-fluid"
                                                                        src="{{AdminAssets()}}/images/big/img2.jpg" alt="Second slide">
                                            </div>
                                        </div>
                                        <div class="carousel-item">
                                            <div class="container"><img class="d-block img-fluid"
                                                                        src="{{AdminAssets()}}/images/big/img3.jpg" alt="Third slide"></div>
                                        </div>
                                    </div>
                        ...
                        <ul class="list-style-none">
                            ...
                            <li>
                                <div class="message-center message-body position-relative" style="height:250px;">
                                    <!-- Message -->
                                    <a href="javascript:void(0)" class="message-item d-flex align-items-center border-bottom px-3 py-2">
                                        <span class="user-img position-relative d-inline-block"> <img src="{{AdminAssets()}}/images/users/1.jpg" alt="user" class="rounded-circle w-100"> <span class="profile-status rounded-circle online"></span> </span>
                                        <div class="w-75 d-inline-block v-middle pl-2">
                                    ...
                                    <!-- Message -->
                                    <a href="javascript:void(0)" class="message-item d-flex align-items-center border-bottom px-3 py-2">
                                        <span class="user-img position-relative d-inline-block"> <img src="{{AdminAssets()}}/images/users/2.jpg" alt="user" class="rounded-circle w-100"> <span class="profile-status rounded-circle busy"></span> </span>
                                        <div class="w-75 d-inline-block v-middle pl-2">
                                    ...
                                    <!-- Message -->
                                    <a href="javascript:void(0)" class="message-item d-flex align-items-center border-bottom px-3 py-2">
                                        <span class="user-img position-relative d-inline-block"> <img src="{{AdminAssets()}}/images/users/3.jpg" alt="user" class="rounded-circle w-100"> <span class="profile-status rounded-circle away"></span> </span>
                                        <div class="w-75 d-inline-block v-middle pl-2">
                                    ...
                                    <!-- Message -->
                                    <a href="javascript:void(0)" class="message-item d-flex align-items-center border-bottom px-3 py-2">
                                        <span class="user-img position-relative d-inline-block"> <img src="{{AdminAssets()}}/images/users/4.jpg" alt="user" class="rounded-circle w-100"> <span class="profile-status rounded-circle offline"></span> </span>
                                        <div class="w-75 d-inline-block v-middle pl-2">
                                            <h5 class="message-title mb-0 mt-1">Pavan kumar</h5> <span class="font-12 text-nowrap d-block text-muted text-truncate">Just see the my admin!</span> <span class="font-12 text-nowrap d-block text-muted">9:02 AM</span> </div>
                                    </a>
                                </div>
                ...
                <li class="nav-item dropdown">
                    <a class="nav-link dropdown-toggle waves-effect waves-dark" href="" data-toggle="dropdown"
                       aria-haspopup="true" aria-expanded="false">
                        <img src="{{AdminAssets()}}/images/users/1.jpg" alt="user" width="30" class="profile-pic rounded-circle" />
                    </a>
                    <div class="dropdown-menu mailbox dropdown-menu-right scale-up">
                        <ul class="dropdown-user list-style-none">
                            <li>
                                <div class="dw-user-box p-3 d-flex">
                                    <div class="u-img"><img src="{{AdminAssets()}}/images/users/1.jpg" alt="user" class="rounded" width="80"></div>
    ...
    <div class="scroll-sidebar">
        <div class="user-profile position-relative" style="background: url({{AdminAssets()}}/images/background/user-info.jpg) no-repeat;">
            ...
            <div class="profile-text pt-1">
                <a href="#" class="dropdown-toggle u-dropdown w-100 text-white d-block" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="true">Markarn Doe</a>
        ...
        <nav class="sidebar-nav">
            ...
            <ul  id="sidebarnav">
                ...
                <li class="sidebar-item"><a  href="{{AdminUrl('profile')}}" class="sidebar-link"><i class="mdi mdi-settings"></i><span class="hide-menu">   اعدادات الصفحه الشخصيه  </span></a></li>
            </ul>
        ...
        <nav class="sidebar-nav">
            <ul id="sidebarnav">
                ...
                <li class="sidebar-item"> <a class="sidebar-link has-arrow waves-effect waves-dark" href="javascript:void(0)" aria-expanded="false"><i class="mdi mdi-notification-clear-all"></i><span class="hide-menu">المناطق والمدن </span></a>
                    <ul aria-expanded="false" class="collapse first-level">

                        <li class="sidebar-item"><a  href="{{AdminUrl('allRegions')}}" class="sidebar-link"><i class="mdi mdi-octagram"></i><span class="hide-menu"> مشاهدة جميع المناطق</span></a></li>
                        <li class="sidebar-item"><a href="{{AdminUrl('allCities')}}" class="sidebar-link"><i class="mdi mdi-octagram"></i><span class="hide-menu"> مشاهدة جميع المدن</span></a></li>
                        <li class="sidebar-item"><a href="{{AdminUrl('allDistricts')}}" class="sidebar-link"><i class="mdi mdi-octagram"></i><span class="hide-menu"> مشاهدة جميع الاحياء </span></a></li>
                ...
                <li class="sidebar-item"> <a class="sidebar-link has-arrow waves-effect waves-dark" href="javascript:void(0)" aria-expanded="false"><i class="mdi mdi-notification-clear-all"></i><span class="hide-menu"> القصور والقاعات  </span></a>
                    <ul aria-expanded="false" class="collapse first-level">

                        <li class="sidebar-item"><a  href="{{AdminUrl('kosor')}}" class="sidebar-link"><i class="mdi mdi-octagram"></i><span class="hide-menu"> مشاهدة جميع القصور</span></a></li>
                        <li class="sidebar-item"><a href="{{AdminUrl('menHalls')}}" class="sidebar-link"><i class="mdi mdi-octagram"></i><span class="hide-menu"> مشاهدة جميع قاعات الرجال</span></a></li>
                        <li class="sidebar-item"><a href="{{AdminUrl('womenHalls')}}" class="sidebar-link"><i class="mdi mdi-octagram"></i><span class="hide-menu"> مشاهدة جميع قاعات النساء </span></a></li>

                    </ul>
                </li>
                <li class="sidebar-item"> <a class="sidebar-link has-arrow waves-effect waves-dark" href="javascript:void(0)" aria-expanded="false"><i class="mdi mdi-notification-clear-all"></i><span class="hide-menu"> المشرفين واصحاب القصور   </span></a>
                    <ul aria-expanded="false" class="collapse first-level">

                        <li class="sidebar-item"><a  href="{{AdminUrl('customer')}}" class="sidebar-link"><i class="mdi mdi-octagram"></i><span class="hide-menu"> مشاهدة جميع المشرفين واصحاب القصور</span></a></li>


                    </ul>
                </li>
                <li class="sidebar-item"> <a class="sidebar-link has-arrow waves-effect waves-dark" href="javascript:void(0)" aria-expanded="false"><i class="mdi mdi-notification-clear-all"></i><span class="hide-menu">   الطلبات    </span></a>
                    <ul aria-expanded="false" class="collapse first-level">

                        <li class="sidebar-item"><a  href="{{AdminUrl('allOrders')}}" class="sidebar-link"><i class="mdi mdi-octagram"></i><span class="hide-menu"> مشاهدة جميع الطلبات  </span></a></li>
         ...
         @else
            <nav class="sidebar-nav">
                        ...
                        <ul  id="sidebarnav">
                            ...
                            <li class="sidebar-item"><a href="{{AdminUrl('details')}}" class="sidebar-link"><i class="mdi mdi-star"></i><span class="hide-menu">   تفاصيل القصر والصور الخاصه به  </span></a></li>
                            <li class="sidebar-item"><a href="{{AdminUrl('menHalls')}}" class="sidebar-link"><i class="mdi mdi-octagram"></i><span class="hide-menu"> مشاهدة  قاعات الرجال</span></a></li>
                            <li class="sidebar-item"><a href="{{AdminUrl('womenHalls')}}" class="sidebar-link"><i class="mdi mdi-heart-half-part"></i><span class="hide-menu"> مشاهدة  قاعات النساء </span></a></li>
                            <li class="sidebar-item"><a href="{{AdminUrl('allOrders')}}" class="sidebar-link"><i class="mdi mdi-cart"></i><span class="hide-menu">    الطلبات  </span></a></li>
        ...
        <ul  id="sidebarnav">
            ...
            <li class="sidebar-item"><a  href="{{AdminUrl('logout')}}" class="sidebar-link"><i class="mdi mdi-power"></i><span class="hide-menu">     تسجيل الخروج   </span></a></li>
        </ul>
        </nav>
    </div>
    <!-- End Sidebar scroll-->
