    ...
    <div class="page-wrapper">
        ...
        <div class="row page-titles">
            <div class="col-md-5 col-12 align-self-center">
                <h3 class="text-themecolor mb-0">قاعات الرجال   </h3>
                            ...
                            <div id="add-contact"  class="modal fade in" tabindex="-1" role="dialog"
                                ...
                                <div class="modal-dialog">
                                    <div class="modal-content">
                                        ...
                                        <form class="form-horizontal form-material" action="{{AdminUrl('menHalls')}}"  method="post" enctype="multipart/form-data">
                                            @csrf
                                        ...
                                        <div id="add-contact{{$row->id}}"  class="modal fade in" tabindex="-1" role="dialog"
                                            ...
                                            <div class="modal-dialog">
                                                <div class="modal-content">
                                                    ...
                                                    <form class="form-horizontal form-material" action="{{AdminUrl('menHalls/'.$row->id)}}"  method="post" enctype="multipart/form-data">
                                                        @csrf
                                                        @method('PUT')
                                                        <div class="modal-body">
                                            ...
                                            <div class="modal-dialog">
                                                <div class="modal-content bg-danger">
                                                    ...
                                                    <div class="modal-footer justify-content-between">
                                                        ...
                                                        <form action="{{AdminUrl('menHalls/'.$row->id)}}" method="post">
                                                            @csrf
                                                            @method('DELETE')
